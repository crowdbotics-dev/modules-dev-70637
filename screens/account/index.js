  ...
  return <View style={styles.container}>
            <ScrollView>
                <View style={styles.profileContainer}>
                    <Image source={require("./PXL_20210111_013232848.jpg")} style={styles.profilePicture} />
                ...
                <View style={[styles.accountHeadings]}>
                    ...
                    <Text style={[styles.inputText1, styles.dvxeowwU]}>Delete Account</Text>
                </View>
          ...
          source={require("./assets/btnSigninwithApple.png")} style={styles.dot} />
                        <View>
                            <View style={styles.orderStatusContainer}>
                                ...
                                <Text style={[styles.statusHeading, styles.statusTime]}>Not Connected</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.mainContainer}>
